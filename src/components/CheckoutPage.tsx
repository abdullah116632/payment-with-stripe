...
const CheckoutPage = ({amount}: {amount: number}) => {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if(error){
            //this point is only reached if thers an immediate error when confirming payment. show the error to your custormer (for example, payment details incomplete)
            setErrorMessage(error.message)
        }else{
            //the payment ui autometically close with success animation.
